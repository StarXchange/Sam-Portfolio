...
export const HERO_CONTENT = 'I am a results-driven Software Engineer with 3+ years of professional experience designing and developing full-stack web applications across insurance and e-commerce sectors. I have honed my skills in front-end technologies like React.js, Next.js, TypeScript, and TailwindCSS, as well as back-end technologies like Node.js, Express.js, SQL, and MongoDB. Proficient in cloud platforms including AWS and Azure, I specialize in building responsive, data-driven solutions that drive business value. My goal is to leverage my expertise to create innovative, scalable applications that deliver exceptional user experiences and measurable results.';
